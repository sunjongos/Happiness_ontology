...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .step-num { font-family: 'Outfit', sans-serif; font-size: 0.8rem; font-weight: 800; color: var(--accent-cyan); margin-bottom: 0.3rem; }
        .step-title { font-size: 1.05rem; font-weight: 700; color: #ffffff; margin-bottom: 0.4rem; }
        ...
        .query-input-group { display: flex; gap: 0.8rem; margin-bottom: 1rem; }
        ...
        <div class="card">
            ...
            <div class="engine-gauges">
                <div class="gauge-card">
                    ...
                    <div style="font-size: 0.75rem; color: var(--text-muted);">4대 위협(경영/질병/이혼/가족) 감시</div>
                </div>
                <div class="gauge-card">
            ...
            <div class="preset-buttons">
                ...
                <button class="btn-preset" onclick="setPreset('질병과 신체 통증이 심해 (건강 위협)')">질병/통증 위협</button>
                <button class="btn-preset" onclick="setPreset('소소한 재미 카드의 일상 배치 방법')">소소한 재미 축적</button>
            </div>
...
<script>
    ...
    const network = new vis.Network(container, { nodes: nodes, edges: edges }, {
        physics: { solver: 'forceAtlas2Based', forceAtlas2Based: { gravitationalConstant: -60, centralGravity: 0.01, springLength: 110 } },
